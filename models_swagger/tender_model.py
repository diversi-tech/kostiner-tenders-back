...
tender_model = namespace_tender.model('Tender', {
    ...
    'tender_number_name': fields.String(required=True, description='tender_number'),
    ...
    "category": fields.List(fields.String, required=True, description='category'),
    ...
    'participants': fields.List(fields.String, required=True, description='participants'),
